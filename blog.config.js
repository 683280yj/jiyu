...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '数字经济 | 产品思维 | 折腾不止', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://idky.tech', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '数字经济, 产品, 运营, 博客, NotionNext', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    '数字经济探索者, 产品思维实践中, 用技术解决问题,欢迎来到我的博客',

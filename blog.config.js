...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '鲫鱼', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '记录生活，表达想法，折腾技术。', // 作者简介
  LINK: 'https://idky.tech', // 网站地址；固定 canonical，避免 Vercel 旧环境变量覆盖为历史域名
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'notion,blog,博客,idky', // 网站关键词 英文逗号隔开
